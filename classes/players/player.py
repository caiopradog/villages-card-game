...
class Player:
    ...
    def get_all_villagers(self) -> [Card]:
    ...
    def get_villagers(self, unit=None, color=None) -> [Card]:
        return [
    ...
    def get_cards_to_add_to_villages(self) -> [Card]:
        return [card for card in self.hand if card.color in self.get_built_villages()]

    def get_card_to_battle(self, village=None) -> (Card, Deck):
    ...
    def choose_card_from_hand(self, reason, optional=False) -> Card:
    ...
    def choose_card_to_trade(self) -> Card:
    ...
    def add_card_to_village(self, village: str, card: Card):
        self.villages[village].add_card(card)
        self.hand.remove_card(card)

    def add_cards_to_village(self, village: str, cards: [Card]):
        for card in cards:
